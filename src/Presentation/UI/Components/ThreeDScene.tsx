...
// TextGeometry와 FontLoader를 가져오는 방식을 변경합니다
import { TextGeometry } from "three/examples/jsm/geometries/TextGeometry.js";
import { FontLoader, Font } from "three/examples/jsm/loaders/FontLoader.js";
import { ShaderMaterial } from "three";
import { BlendFunction, Effect } from "postprocessing";

// TextGeometry를 React Three Fiber에서 사용할 수 있도록 확장합니다
extend({ TextGeometry });

// TextGeometry에 대한 타입 선언을 추가합니다
...
const ColorAdjustmentShader: ColorAdjustmentShaderParameters = {
  uniforms: {
    tDiffuse: { value: null },
    saturation: { value: 1.1 }, // 채도 약간 증가
    contrast: { value: 1.1 }, // 대비 증가
    brightness: { value: 1.05 }, // 밝기 약간 증가
  },
  vertexShader: `
        varying vec2 vUv;
        void main() {
    ...
    scene.traverse((child) => {
      if (child instanceof THREE.Mesh) {
        ...
        if (child.material) {
          ...
          //   // 예시 RGB 값 (200, 150, 100)을 실제 C4D에서 사용한 값으로 교체하세요
          //   const c4dRed = 200;
          //   const c4dGreen = 150;
          //   const c4dBlue = 100;
